INSERT INTO location(city, state) VALUES('Boulder', 'Colorado');
INSERT INTO companies( name, description,location_id) VALUES('Techstars', 'Techstars is an American seed accelerator founded in 2006 in Boulder, Colorado. Since 2006, Techstars has invested in more than 2,200 companies and today has a market cap of $27 Billion. Fewer than 1% of applicants are accepted
...
INSERT INTO location(city, state) VALUES('Santa Clara', 'California');
INSERT INTO companies( name, description,location_id) VALUES( 'AMD', 'Advanced Micro Devices, Inc., more simply known as AMD, is a multinational semiconductor company. It develops and manufactures a range of microprocessors and a number of other semiconductor components including motherboard chipsets, embedded processors, and graphics processing units (GPUs) for personal computers, servers, workstations, data centers, and embedded system applications',
4);
...
INSERT INTO location(city, state) VALUES('Armonk', 'New York');
INSERT INTO companies(name, description,location_id) VALUES('IBM', 'Founded in 1911, the International Business Machines Corporation, better known as IBM, is a multinational information technology company operating in more than 170 countries. Manufacturing and marketing computer hardware, middleware, and software and providing hosting and consulting services, IBM is also a major technology research organization',
6);
...
INSERT INTO location(city, state) VALUES('San Francisco', 'California');
INSERT INTO companies(name, description,location_id) VALUES('Airbnb', 'Airbnb is a marketplace dedicated to connecting travelers to rooms, apartments, houses, and unique accommodations and experiences around the world. It helps list, discover, and book distinctive spaces and facilitates bookings and financial transactions',
8);
...
INSERT INTO location(city, state) VALUES('Stamford', 'Connecticut');
INSERT INTO companies( name, description,location_id) VALUES('Charter Communications', 'Charter Communications, Inc. is a telecommunications and mass media company. Operating under the Spectrum brand, Charter Communications is one of the largest cable operators, pay-TV operators and telephone providers in the United States',
9);
